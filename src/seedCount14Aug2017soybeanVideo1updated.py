...
VERBOSE = True        # output intermediate images
FINAL_FRAME = True    # output final image frame with seeds and contours noted on original image
    ...
    if (fc%MOD_VAL==MOD_OFFSET):
        for i in seeds:
            ...
            if (i.done==False):
                ...
                if ((i.age >= i.max_age) and (i.age > i.updates) and (i.updates <= i.max_age)):
                    num_seeds -=1
                    i.setDone()
